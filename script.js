$(function(){
  ...
  $(document).ready(function() {
    ...
    var speedX = Math.floor(Math.random() * 9) + 1;
    var speedY = Math.floor(Math.random() * 9) + 1;
  
    var accelerationX = 0.005;
    var accelerationY = 0.005;
    ...
    function animateBall() {
      ...
      if (survivedTime === 0) {
        ...
        result.text("Point : " + Math.round(survivedTime) * 2 + " point"); // 버틴 시간 표시
